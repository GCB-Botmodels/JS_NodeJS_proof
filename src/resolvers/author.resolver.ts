...
import { Length, IsString } from 'class-validator'; //sirve para hacer validaciones del tipo de datos que queremos ingresen a la base y las inconsistencias que podrían generar 
